...
|
*/
$config['report']['report_to_header'] = '{"group":"default","max_age":31536000,"endpoints":[{"url":"https://tangerangkota.report-uri.com/a/d/g"}],"include_subdomains":false}';
...
$config['scripting']['style_src'] 	= array(
	...
	'hash' 	=> [
		...
		"'sha256-MnUZkZJHks8wEa7MTb69TuCGuLCBuDAxGphrDApyxGY='",
		"'sha256-UJvLHsqo3kGnJEzk/tCRnIXtEjf9QTw1FTfUuAUnLGw='",
		"'sha256-wS7xf+bhXBr5EM064hQkAW0vX3ks5VoxbGn+KQC/Vhk='",
		"'sha256-fviu5RwuBYFcCd5CDanhy6NCLufcwvCAbm061aSqhoQ='",
		"'sha256-cxL35Ug49Sl1zHMOdz/r0xinQ6BYGgClHdDCk2XPTzE='",
		"'sha256-HFzeH8dvABpRFCAXQXyZFWp9+wSRhtBJedsgvQDLzcY='",
...
$config['scripting']['object_src'] 	= array(
	'source'=> ["https://localhost/sidota/_/files/"],
	'mode' 	=> [],
	'hash' 	=> [],
	'nonce' => NULL
);
...
$config['content']['connect_src']= array(
	'source'=> ["'self'", "https://api.ilovepdf.com"]
);
