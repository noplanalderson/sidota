...
defined('BASEPATH') OR die('No Direct Script Access Allowed');?>
        ...
        <div class="az-content-body">
          ...
          <div class="card card-table-two rounded mb-5">
            ...
            <div class="row pd-30 text-center d-flex">
              <?php 
                if(empty($documentations)) echo '<h3 class="pd-20 text-white">No Image Available</h3>';

                foreach ($documentations as $doc) :
              ?>
              <div class="col-md-3 col-sm-4 col-xs-12 mt-2 pd-10 bg-dark-200 text-white table-bordered <?= encrypt($doc->picture);?>">
                <div class="thumbnail w-100">
                  <div class="image view view-first w-100">
                    <a href="#" class="modal-effect show" data-effect="effect-flip-vertical" data-toggle="modal" data-target="#show-image" data-id="<?= encrypt($doc->picture);?>">
                      <img class="w-100 h-100 d-block rounded" src="<?= site_url('_/images/uploads/'.$employeeID.'/'.$doc->upload_date.'/thumbnail/'.$doc->picture);?>" alt="<?= $doc->activity;?>" />
                    </a>
                  </div>
                  <div class="caption">
    ...
    <div id="show-image" class="modal">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-demo bg-dark">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-md-12 text-center">
                <img id="image" class="w-100 d-block ml-auto mr-auto bg-transparent">
              </div>
            </div>
          </div><!-- modal-body -->
