            ...
            <div class="card-body bg-dark-200">
                ...
                <div class="">
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                      <div class="input-group">
                        ...
                        <input type="text" id="date_activity" name="date_activity" class="form-control bg-dark text-white fc-datepicker" data-parsley-errors-container="#slError" value="<?= $report->date_activity;?>" placeholder="YYYY-MM-DD" required>
                      </div>
                      <div id="slError"></div>
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                      <input type="text" id="location" name="location" class="form-control bg-dark text-white" value="<?= $report->location;?>" placeholder="Location" >
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                      <textarea id="location_address" rows="3" name="location_address" class="form-control bg-dark text-white" value="<?= $report->location_address;?>" placeholder="Location Address"></textarea>
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    <div class="col-md-3">
                      <label class="form-label text-white mg-b-0">Used Tool *</label>
                    ...
                    <div class="col-md-9">
                      <div id="field" class="mg-t-20">
                        ...
                        ?>
                          <div class="row added <?= encrypt($tool->tool_id) ?> mg-t-20">
                            <div class="col-md-4 mg-t-5 mg-md-t-0">
                              <input type="text" id="tool-1" name="tool[]" class="form-control bg-dark text-white" placeholder="Used Tool" value="<?= $tool->tool;?>">
                            </div>
                            <div class="col-md-4 mg-t-5 mg-md-t-0">
                              <input type="text" id="owner-1" name="tool_owner[]" class="form-control bg-dark text-white" placeholder="Tool Owner" value="<?= $tool->tool_owner;?>">
                            </div>
                        ...
                        <div class="row added mg-t-20">
                          <div class="col-md-4 mg-t-5 mg-md-t-0">
                            <input type="text" id="tool-1" name="tool[]" class="form-control bg-dark text-white" placeholder="Used Tool" value="">
                          </div>
                          <div class="col-md-4 mg-t-5 mg-md-t-0">
                            <input type="text" id="owner-1" name="tool_owner[]" class="form-control bg-dark text-white" placeholder="Tool Owner" value="">
                          </div>
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                      <textarea id="activity" rows="3" name="activity" class="form-control bg-dark text-white" placeholder="Activity Report" required><?= $report->activity;?></textarea>
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                      <textarea id="problem" rows="3" name="problem" class="form-control bg-dark text-white" placeholder="Problem"><?= $report->problem;?></textarea>
                    </div><!-- col -->
                  </div><!-- row -->

                  <div class="row row-xs align-items-center mg-b-20">
                    <div class="col-md-3">
                      <label class="form-label text-white mg-b-0">Action(s) (Separate by comma to create action lists)</label>
                    </div><!-- col -->
                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                      <input id="action" name="action" class="form-control bg-dark text-white" placeholder="Action Lists" value="<?= $report->action;?>">
                    </div><!-- col -->
                  </div><!-- row -->

                  <div class="row row-xs align-items-center mg-b-20">
                    <div class="col-md-3">
                      <label class="form-label text-white mg-b-0">Activity Result (Separate by comma to create result lists)*</label>
                    </div><!-- col -->
                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                      <input id="result" name="result_activity" class="form-control bg-dark text-white" placeholder="Activity Result" value="<?= $report->result_activity;?>" required>
                    </div><!-- col -->
                  </div><!-- row -->
