          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 mg-t-20 mg-lg-t-0">
              <div class="card card-table-two">
                ...
                <div class="card-body pd-30 pd-sm-40 bg-gray-200">
                  <?= form_open_multipart('submit-report', 'id="activityForm" method="post"');?>
                    ...
                    <div class="">
                      ...
                      <div class="row row-xs align-items-center mg-b-20">
                        ...
                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                          <div class="input-group">
                            ...
                            <input type="text" id="date_activity" name="date_activity" class="form-control fc-datepicker" data-parsley-errors-container="#slError" placeholder="YYYY-MM-DD" value="" required>
                          </div>
                          <div id="slError"></div>
                        </div><!-- col -->
                      </div><!-- row -->
                      ...
                      <div class="row row-xs align-items-center mg-b-20">
                        ...
                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                          <input type="text" id="location" name="location" class="form-control" placeholder="Location" value="" required>
                        </div><!-- col -->
                      </div><!-- row -->
                      ...
                      <div class="row row-xs align-items-center mg-b-20">
                        ...
                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                          <textarea rows="3" id="location_address" name="location_address" class="form-control" placeholder="Location Address"></textarea>
                        </div><!-- col -->
                      </div><!-- row -->
                      ...
                      <div class="row row-xs align-items-center mg-b-20">
                        <div class="col-md-3">
                          <label class="form-label mg-b-0">Used Tools *</label>
                        ...
                        <div class="col-md-9">
                          <div class="row">
                            <div class="col-md-6 mg-t-5 mg-md-t-0">
                              <input type="text" name="tool[]" class="form-control" placeholder="Tool" value="">
                            </div>
                            <div class="col-md-6 mg-t-5 mg-md-t-0">
                              <input type="text" name="tool_owner[]" class="form-control" placeholder="Tool Owner" value="">
                            </div>
                          </div>
                      ...
                      <div class="row row-xs align-items-center mg-b-20">
                        ...
                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                          <textarea rows="3" id="activity" name="activity" class="form-control" placeholder="Activity Report" required></textarea>
                        </div><!-- col -->
                      </div><!-- row -->
                      ...
                      <div class="row row-xs align-items-center mg-b-20">
                        ...
                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                          <textarea rows="3" id="problem" name="problem" class="form-control" placeholder="Problem(s)"></textarea>
                        </div><!-- col -->
                      </div><!-- row -->

                      <div class="row row-xs align-items-center mg-b-20">
                        <div class="col-md-3">
                          <label class="form-label mg-b-0">Action (Separate by Comma to create action list)</label>
                        </div><!-- col -->
                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                          <input id="action" name="action" class="form-control" placeholder="Action(s)" value="">
                        </div><!-- col -->
                      </div><!-- row -->

                      <div class="row row-xs align-items-center mg-b-20">
                        <div class="col-md-3">
                          <label class="form-label mg-b-0">Activity Result (Separate by Comma to create result list)*</label>
                        </div><!-- col -->
                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                          <input id="result_activity" name="result_activity" class="form-control" placeholder="Result" value="" required>
                        </div><!-- col -->
                      </div><!-- row -->
