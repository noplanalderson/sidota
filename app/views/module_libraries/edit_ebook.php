              ...
              <?= form_open_multipart('libraries/update', 'id="ebookForm" method="post"');?>
                ...
                <div class="">
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <div id="slWrapper" class="parsley-select">
                        <select class="form-control select2 w-100 bg-dark" data-placeholder="Choose Categories" data-parsley-class-handler="#slWrapper" data-parsley-errors-container="#slErrorContainer" name="category[]" multiple="multiple" required>
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <input type="text" name="ebook_title" class="form-control" placeholder="Ebook Title" value="<?= $ebook->ebook_title;?>" required>
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <textarea rows="3" name="ebook_description" class="form-control" placeholder="Ebook Description (Max. 255 Character)" maxlength="255" ><?= $ebook->ebook_description;?></textarea>
                    </div><!-- col -->
                  </div><!-- row -->
                    ...
                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                      <div class="row row-sm">
                        <div class="col-md-11 col-sm-6 col-xs-6">
                          ...
                          <input type="file" id="file" class="form-control" name="file" data-allowed-file-extensions='["pdf","txt","doc","docx","ppt","pptx"]'>
