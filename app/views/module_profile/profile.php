        ...
        <div class="az-content-left az-content-left-profile">
          ...
          <div class="az-profile-overview">
            ...
            <div class="d-flex justify-content-between mg-b-20">
              <div>
                <h5 class="az-profile-name"><?= $profile->employee_name;?></h5>
            ...
            <label class="az-content-label tx-13 mg-b-20">Websites &amp; Sosial Media</label>
          ...
          <div class="az-profile-body">
            ...
            <div class="row mg-b-20">
              ...
              <div class="col-md-5 col-xl-4 mg-t-40 mg-md-t-0">
                <div class="az-content-label tx-13 mg-b-20">Top 5 Kategori Pekerjaan</div>
                  <?php
            ...
            <div class="row">
              <div class="col-md-12 col-xl-8">
                <div class="az-content-label tx-13 mg-b-25">Place, DoB & Address</div>
