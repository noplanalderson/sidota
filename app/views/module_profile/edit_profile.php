                      ...
                      <div class="row row-xs align-items-center mg-b-20">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                          <div class="input-group">
                            ...
                            <input type="date" name="employee_date_ob" class="form-control" data-parsley-errors-container="#slError" placeholder="YYYY-MM-DD" value="<?= $employee->employee_date_ob;?>" required>
                          </div>
                        </div><!-- col -->
                      </div><!-- row -->
