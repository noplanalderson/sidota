  ...
  var reports = $('#reports').DataTable({
    ...
    ordering: false,
        ...
        buttons: [
        {
          ...
          title: "Work Reports - <?= $employee->employee_name;?>",
          messageTop: "<?= $employee->employee_name;?> \n",
          messageTop: "<?= ucwords($employee->jobdesc_name).' '.$employee->jobdesc_series;?> \n",
            ...
            customize : function(doc) {
              doc.content.splice(0, 1, {
                text: [
                  ...
                  {
                    text: "<?= ucwords($employee->jobdesc_name).' '.$employee->jobdesc_series;?> \n\n\n",
                    fontSize: 11,
                    alignment: 'center'
                  },
                ]
