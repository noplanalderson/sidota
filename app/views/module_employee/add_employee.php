              ...
              <?= form_open('submit-employee', 'id="employeeForm" method="post"');?>
                ...
                <div class="">
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <input type="text" name="employee_place_ob" class="form-control" placeholder="Place of Birth" required>
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <div class="input-group">
                        ...
                        <input type="date" name="employee_date_ob" class="form-control" data-parsley-errors-container="#slError" placeholder="YYYY-MM-DD" required>
                      </div>
                      <div id="slError"></div>
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <textarea rows="3" name="employee_address" class="form-control" required></textarea>
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <textarea rows="3" name="employee_bio" class="form-control"></textarea>
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <input type="text" name="employee_phone" class="form-control" placeholder="Employee Phone" required>
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <input type="email" name="user_email" class="form-control" placeholder="you@somewhere.com" required>
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <input type="url" name="facebook" class="form-control" placeholder="https://facebook.com/yourprofile">
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <input type="url" name="instagram" class="form-control" placeholder="https://instagram.com/youraccount">
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <input type="url" name="website" class="form-control" placeholder="https://website.com/">
                    </div><!-- col -->
                  </div><!-- row -->
