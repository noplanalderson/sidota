                ...
                <div class="">
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      ...
                      <input type="text" name="employee_name" class="form-control bg-dark text-white" placeholder="Employee Name" value="<?= $employee->employee_name ?>" required>
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    <div class="col-md-4">
                      <label class="form-label text-white mg-b-0">Jobdesc Series *</label>
                    </div><!-- col -->
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <input type="number" min="1" name="jobdesc_series" class="form-control bg-dark text-white" placeholder="0" value="<?= $employee->jobdesc_series ?>" required>
                    </div><!-- col -->
                  </div><!-- row -->
                  ...
                  <div class="row row-xs align-items-center mg-b-20">
                    ...
                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                      <div class="form-group mg-b-20">
                        <label class="ckbox">
                          <input type="checkbox" id="is_active" name="is_active" value="1" <?php if($employee->is_active == 1) : ?>checked <?php endif;?>><span class="mb-2 text-white">Active</span>
                        </label>
                      </div>
                    </div>
                  </div><!-- row -->
